...
import { CollectionIcon, MailOpenIcon, XIcon } from "@heroicons/react/outline";
              ...
              <div className="py-12">
                <div className="px-4 sm:px-12">
                  <div className="flex justify-center">
                    ...
                    | Kanban <span className="text-blue-500 font-bold">Pong</span>
                  </span>
                      </a>
                    </Link>
                  </div>
                  ...
                  {!showSignIn ? (
                    <Dialog.Description className="mt-2 text-gray-500 text-base text-center">
                      Please Create an Account to List your User Stories and
